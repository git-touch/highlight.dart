...
var typescript = Mode(refs: {
  '~contains~8~contains~2~contains~3':
  ...
  '~contains~8~contains~2~contains~2':
      Mode(className: "meta", begin: "@[A-Za-z\$_][0-9A-Za-z\$_]*"),
  '~contains~8~contains~2': Mode(
      className: "params",
      begin: "\\(",
      end: "\\)",
      excludeBegin: true,
      ...
      contains: [
        ...
        Mode(ref: '~contains~8~contains~2~contains~2'),
  ...
  Mode(
      ...
      contains: [
        ...
        Mode(
            ...
            relevance: 0),
        Mode(ref: '~contains~8~contains~2')
      ],
      illegal: "%",
      relevance: 0),
  Mode(
      ...
      excludeEnd: true,
      contains: [Mode(self: true), Mode(ref: '~contains~8~contains~2')]),
