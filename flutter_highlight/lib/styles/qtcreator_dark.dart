...
var style = {
  'container': TextStyle(backgroundColor: Color(0xff000000)),
  ...
  'selector-class': TextStyle(color: Color(0xffaaaaff)),
  ...
  'title': TextStyle(color: Color(0xff8888ff)),
  ...
  'type': TextStyle(color: Color(0xffff55ff)),
