...
var style = {
  ...
  'constructor': TextStyle(color: Color(0xff61aeee)),
  'function': TextStyle(color: Color(0xff61aeee)),
  'params': TextStyle(color: Color(0xffA6E22E)),
  'typing': TextStyle(color: Color(0xffFD971F)),
  'module': TextStyle(color: Color(0xff7e57c2)),
  'constructor': TextStyle(color: Color(0xffe2b93d)),
  'string': TextStyle(color: Color(0xff9CCC65)),
